      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold gradient-text">Anime Hub</h3>
            <p className="text-gray-400">
              Building the largest anime community in Serbia, based in Novi Sad. 
              Connecting anime fans since 2026.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3 text-gray-400">
                <MapPin className="w-5 h-5 mt-1 text-neon-pink" />
        ...
        <div className="border-t border-dark-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2026 Anime Hub Novi Sad. All rights reserved.
          </p>
          <p className="text-gray-400 text-sm mt-2 md:mt-0 flex items-center">
            Made with{' '}
            <Heart
              className="w-5 h-5 mx-1 text-neon-pink drop-shadow-[0_0_6px_#ff00ff]"
